...
#ifndef LV_CUSTOMER_FONT_ALIBABAPUHUITIREGULAR_100
#define LV_CUSTOMER_FONT_ALIBABAPUHUITIREGULAR_100 1
#endif

#if LV_CUSTOMER_FONT_ALIBABAPUHUITIREGULAR_100
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 920, .box_w = 27, .box_h = 70, .ofs_x = 10, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_customer_font_AlibabaPuHuiTiRegular_100 = {
#else
lv_font_t lv_customer_font_AlibabaPuHuiTiRegular_100 = {
#endif
...
#endif /*#if LV_CUSTOMER_FONT_ALIBABAPUHUITIREGULAR_100*/
