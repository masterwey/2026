...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_samrt_lab_del = true;
    ui->screen_smart_cabinet_del = true;
    ui->screen_cfg_dev_del = true;
    ui->screen_cfg_alarm_del = true;
    ui->screen_cfg_door_del = true;
    ui->screen_cfg_self_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_samrt_lab(ui);
    lv_screen_load(ui->screen_samrt_lab);
}
...
void init_keyboard(lv_ui *ui)
{
    ...
    lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_AlibabaPuHuiTiRegular_18, LV_PART_MAIN|LV_STATE_DEFAULT);
}
